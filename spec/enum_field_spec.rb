...
class EnumExample
  ...
  enum_field :role, type: Mongoid::StringifiedSymbol, default: :standard, allow_nil: true, suffix: false, prefix: '', values: [
      :admin,
      :standard
  ]

  enum_field :bin, type: Mongoid::StringifiedSymbol, values: [:hungry, :bored]
